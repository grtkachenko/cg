...
struct Newtone_method_viewer : cg::visualization::viewer_adapter
{
   ...
   Newtone_method_viewer() : point_colors(MAX_POINT_X * 2)
   {
...
//      }
   ...
   bool on_release(const cg::point_2 & p)
   {
//      last_pos = p;
      return true;
   }
...
private:
   ...
   const static int MAX_POINT_X = 1000;
   const static int MAX_POINT_Y = 500;
